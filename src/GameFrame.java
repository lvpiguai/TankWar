...
public class GameFrame extends Frame implements ActionListener {
	...
	MenuItem jmi1 = null, jmi2 = null, jmi3 = null, jmi4 = null, jmi5 = null, jmi6 = null, jmi7 = null, jmi8 = null,jmi9 = null;
	...
	public GameFrame() {
		...
		theRiver.add(new River(85, 100, this));// 河流
	...
	private class PaintThread implements Runnable {
		public void run() {
			...
			while (printable) {// 当printable为true时
				repaint();// 重绘
				try {
					Thread.sleep(50);
